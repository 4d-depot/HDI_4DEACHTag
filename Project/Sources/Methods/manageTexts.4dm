...
If (Is Windows:C1573)
	...
	$n:=Size of array:C274(_TabLineHTML)
	For ($i; 1; $n)
		ST SET ATTRIBUTES:C1093(_TabLineHTML{$i}; ST Start text:K78:15; ST End text:K78:16; Attribute text size:K65:6; 13)
	End for 
End if 
...
If (Is macOS:C1572)
	...
	$n:=Size of array:C274(_TabLineHTML)
	For ($i; 1; $n)
		ST SET ATTRIBUTES:C1093(_TabLineHTML{$i}; ST Start text:K78:15; ST End text:K78:16; Attribute text size:K65:6; 15)
	End for 
End if 